import { client } from "../db.js"; // asumo que db.js exporta `client` o `pool`

export async function getAllUsuarios() {
  const res = await client.query("SELECT id, nombre, email, telefono, fecha_registro, tipo_usuario_id FROM usuarios ORDER BY id");
  return res.rows;
}
